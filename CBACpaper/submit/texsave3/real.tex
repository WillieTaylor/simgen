...
commonly observerd in such structures.  (\Fig{rhod-model}).
...
preiction was taken as a starting position for each phosphate (\Fig{ribo0}) and under the
...
models containing excessive P-P clashes were excluded. (\Fig{ribo-score}).
...
RMSD have topological differences from the native (\Fig{ribo-models}).     
