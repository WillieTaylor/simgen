...
The motion of each unit is purely random with a fixed step-size
...
\begin{figure}
\centering
\epsfxsize=300pt \epsfbox{figs/control.eps}
\caption{
\label{Fig:control}
...
The length of cylinders and ellipsoids is set by reading in two end-points from the
